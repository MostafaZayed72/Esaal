    ...
    ><v-row
      ><v-col cols="12" style="direction: rtl"
        ...
        <h1 class="w-100 text-center mt-6">
          أصبح اللايف كوتشينج من المجالات التي تحظى باهتمام كبير في المملكة
          العربية السعودية، حيث يسعى العديد من الأشخاص إلى تطوير مهاراتهم وتحقيق
          أهدافهم من خلال الاستعانة بمدربي اللايف كوتشينج. وفي هذا المقال،
          سنتعرف على أسعار جلسات لايف كوتشينج في السعودية وسنقدم بعض النصائح
          لاختيار المدرب المناسب.
        </h1>
        <h1 class="mt-20 text-center text-3xl w-100">
          يختلف سعر جلسات اللايف كوتشينج في السعودية حسب عدة عوامل، منها:
        </h1>
        <h1 class="w-100 text-center mt-6">
          - خبرة المدرب: فكلما زادت خبرة المدرب، زاد سعر جلساته.
        </h1>
        <h1 class="w-100 text-center mt-6">
          - مستوى التعليم الخاص بالمدرب: فكلما كان المدرب حاصلًا على مؤهلات
          علمية عالية، زاد سعر جلساته.
        </h1>
        <h1 class="w-100 text-center mt-6">
          - مدة الجلسة: فكلما زادت مدة الجلسة، زاد سعرها.
        </h1>
        <h1 class="w-100 text-center mt-6">
          - نوع الخدمات المقدمة: فكلما كانت الخدمات المقدمة أكثر شمولاً، زاد
          سعرها.
        </h1>
        <h1 class="w-100 text-center mt-12 py-2" style="border: 1px solid">
          وبشكل عام، تتراوح أسعار جلسات اللايف كوتشينج في السعودية بين 150
          ريالًا سعوديًا و500 ريال سعودي.
        </h1>
