...
const medical_list = [
  {
    id: 0,
    image:
      'https://cdn.statically.io/gh/AhmedMSoliman160/20230301v01/main/assets/images/icons/pediatrics.svg',
    name: 'طب أطفال',
  },
  {
    id: 1,
    image:
      'https://cdn.statically.io/gh/AhmedMSoliman160/20230301v01/main/assets/images/icons/svgexport-6(93).svg',
  ...
  <div>
    ...
    >
      ...
      >
        ...
        >
          <i class="fa-solid fa-apple-whole text-5xl" />
        ...
        <div
          ...
          @click="show_psych"
        >
          <i class="fa-solid fa-user-doctor text-5xl" />
          <h1 class="font-bold text-lg">
            استشارات نفسية
          </h1>
        </div>
        <div
          ...
          @click="show_medical"
        >
          <i class="fa-solid fa-stethoscope text-5xl" />
          <h1 class="font-bold text-lg">
            استشارات طبية
          </h1>
        </div>
      ...
      >
        ...
        <div class="select flex flex-col items-end justify-center gap-2">
          <h1 class="text-end mr-20 mt-2">
            اختر التخصص و وسيلة التواصل
          </h1>
          <v-select
        ...
        >
          ...
          >
            <i class="fa-solid fa-message text-5xl mt-12 text-green-700" />
          ...
          <div
            ...
            style="width: 150px; height: 150px; transform: translateY(-25px)"
          >
            <i class="fa-solid fa-phone text-5xl mt-12 text-green-700" />
            <h1 class="font-bold text-lg mt-2">
              استشارة صوتية
            </h1>
          </div>
          <div
            ...
            style="width: 150px; height: 150px; transform: translateY(-25px)"
          >
            <i class="fa-solid fa-video text-5xl mt-12 text-green-700" />
            <h1 class="font-bold text-lg mt-2">
              استشارة فيديو
            </h1>
          </div>
